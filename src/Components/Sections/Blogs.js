    ...
    return (
        <BlogsStyled id='blogs' theme={theme}>
            <div className="center-title">
                <Title name={'NGOs'} desc={`Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil suscipit corrupti voluptates magnam, voluptatem aliquid laborum consectetur.`} />
            </div>
